defmodule EthValidationTest do
  ...
  describe "to_checksum_address/1" do
    test "should return correct checksum" do
      {:ok, checksum} =
        EthValidation.to_checksum_address("0xfb6916095ca1df60bb79ce92ce3ea74c37c5d359")
    ...
    test "should return correct checksum 2" do
      {:ok, checksum} =
        EthValidation.to_checksum_address("0x52908400098527886E0F7030069857D2E4169EE7")
    ...
    test "should return correct checksum 3" do
      {:ok, checksum} =
        EthValidation.to_checksum_address("0xde709f2102306220921060314715629080e2fb77")
    ...
    test "should return correct checksum 4" do
      {:ok, checksum} =
        EthValidation.to_checksum_address("0xdbF03B407c01E7cD3CBea99509d93f8DDDC8C6FB")
